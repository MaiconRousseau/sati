...
public class EdicaoController {
    ...
    private EdicaoModel edicaoModel = new EdicaoModel();
    ...
    public boolean verificarAtributos(Edicao edicao) {
    ...
    public boolean cadastrarEdicao(Edicao edicao) {
        ...
        boolean verifica = this.verificarAtributos(edicao);
    ...
    private boolean buscarEdicaoExistente(Edicao edicao, String tipo) {
